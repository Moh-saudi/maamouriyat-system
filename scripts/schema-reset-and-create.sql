-- WARNING: This resets the Maamouriyat application schema objects in public.
-- Use this only while setting up the project or if the previous schema run was partial.
