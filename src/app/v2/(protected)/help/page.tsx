...
export default async function V2HelpPage({
  ...
  if (isFieldInspector || canWorkMissions) {
    guides.push({
      ...
      icon: ClipboardList,
      steps: [
        'ابدأ من تبويب «مكلف بها». إذا كان التكليف يشمل عدة منشآت فسيظهر كتكلـيف مجمع؛ افتحه لرؤية المأموريات الفردية.',
        'في الدفعات الكبيرة قد تُجمع المأموريات داخليًا حسب المحافظة والإدارة الصحية لتسهيل الوصول للمنشأة المطلوبة.',
