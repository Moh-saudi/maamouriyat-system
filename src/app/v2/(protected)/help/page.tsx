...
export default async function V2HelpPage({
  ...
  if (canPrepareMissions) {
    guides.push({
      ...
      icon: FileText,
      steps: [
        'اختر نموذج المرور والمنشآت الواقعة داخل نطاق الخدمة المسموح لك به.',
        'اختر الفريق المقترح وحدد رئيس الفريق والموعد والأولوية والتعليمات.',
        'راجع الدفعة قبل الإرسال؛ اختيار أكثر من منشأة ينشئ مأمورية مستقلة لكل منشأة.',
        'بعد الإرسال تصبح الدفعة بانتظار الاعتماد ولا يصل تكليف للمفتشين إلا بعد اعتمادها.',
      ],
    })
  }
