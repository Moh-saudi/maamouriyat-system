...
export function MissionExecutionForm({
  ...
  const [canChangeTemplate, setCanChangeTemplate] = useState(false)
  const [canManageTemplatePolicy, setCanManageTemplatePolicy] = useState(false)
  const [teamTemplateChangeAllowed, setTeamTemplateChangeAllowed] = useState(false)
  const [checklistAnswerCount, setChecklistAnswerCount] = useState(0)
  const [templateChangeOpen, setTemplateChangeOpen] = useState(false)
  const [pendingTemplateId, setPendingTemplateId] = useState('')
  const [templateChangeReason, setTemplateChangeReason] = useState('')
  const [templateChangeBusy, setTemplateChangeBusy] = useState(false)
  const [templatePolicyBusy, setTemplatePolicyBusy] = useState(false)
