        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-[9px] leading-5 text-slate-500">
              سجل نتيجة كل منشأة أولًا: تم المرور أو لم يتم مع السبب والموقع
              والوقت. المدة الفعلية والتقرير والاستحقاق المالي تُثبت بعد اكتمال سجل التكليف كله.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="text-xs font-black text-amber-900">
              اكتمل تسجيل نتائج المنشآت وينتظر إنهاء رئيس الفريق
            </h2>
            <p className="mt-1 text-[9px] leading-5 text-amber-700">
              لكل منشأة نتيجة نهائية مسجلة. رئيس فريق المأمورية هو الذي يثبت المدة
