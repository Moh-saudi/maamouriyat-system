...
export const roleDefinitions = {
  superadmin: {
    ...
    name: 'مشرف عام',
    navigation: ['dashboard', 'missions', 'violations', 'facilities', 'organizations', 'users', 'leadership-plan', 'targets', 'targets-report', 'settings', 'checklists'] as const,
    minLevel: 1,
    maxLevel: 1,
  },
  techadmin: {
    ...
    name: 'الدعم الفني',
    navigation: ['dashboard', 'facilities', 'organizations', 'users', 'leadership-plan', 'targets', 'targets-report', 'checklists', 'settings'] as const,
    minLevel: 0,
    maxLevel: 0,
  },
  sector: {
    ...
    name: 'مسؤول قطاع',
    navigation: ['dashboard', 'missions', 'violations', 'facilities', 'organizations', 'users', 'leadership-plan', 'targets', 'targets-report'] as const,
    minLevel: 2,
    maxLevel: 2,
  },
  central: {
    ...
    navigation: ['dashboard', 'missions', 'violations', 'facilities', 'organizations', 'leadership-plan', 'targets', 'targets-report'] as const,
    minLevel: 3,
    maxLevel: 3,
  },
  generalmanager: {
  ...
  directorate: {
    ...
    name: 'مدير مديرية',
    navigation: ['dashboard', 'missions', 'violations', 'facilities', 'leadership-plan', 'targets', 'targets-report'] as const,
    minLevel: 5,
    maxLevel: 5,
  },
  creator: {
    ...
    navigation: ['dashboard', 'missions', 'violations', 'leadership-plan', 'targets', 'targets-report'] as const,
    minLevel: 6,
    maxLevel: 6,
  },
  inspector: {
    ...
    name: 'القائم بالمرور',
    navigation: ['dashboard', 'missions', 'violations', 'targets', 'targets-report'] as const,
    minLevel: 7,
    maxLevel: 7,
  },
} as const
