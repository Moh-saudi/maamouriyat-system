...
export const roleDefinitions = {
  superadmin: {
    ...
    name: 'مشرف عام',
    navigation: ['dashboard', 'missions', 'violations', 'facilities', 'users', 'leadership-plan', 'targets', 'targets-report', 'settings', 'checklists'] as const,
    minLevel: 1,
    maxLevel: 1,
  },
  techadmin: {
    ...
    name: 'الدعم الفني',
    navigation: ['dashboard', 'facilities', 'users', 'leadership-plan', 'targets', 'targets-report', 'checklists', 'settings'] as const,
    minLevel: 0,
    maxLevel: 0,
  },
  sector: {
    ...
    name: 'مسؤول قطاع',
    navigation: ['dashboard', 'missions', 'violations', 'facilities', 'users', 'leadership-plan', 'targets', 'targets-report'] as const,
    minLevel: 2,
    maxLevel: 2,
  },
  central: {
